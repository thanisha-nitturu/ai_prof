...
$string['completion_undo_confirm_title'] = 'Undo progress?';
$string['completion_undo_confirm_message'] = 'Your progress will be undone. Do you want to continue?';
$string['completion_undo_confirm_button'] = 'Undo progress';
// Module Content activities (with quiz option)
$string['completion_confirm_title'] = 'Well done! You’ve completed this module.';
$string['completion_confirm_message'] = 'Would you like to test your knowledge immediately, or take the quiz later?';
$string['completion_confirm_complete'] = 'Later';
$string['completion_confirm_complete_quiz'] = 'Start quiz';
// Other activities (video, etc.)
$string['completion_video_title'] = 'Great job! You have completed watching video';
$string['completion_outline_title'] = 'Great job! You have reviewed the module outline';
$string['completion_video_message'] = 'Mark this activity as complete?';
$string['completion_video_complete'] = 'Mark as Complete';
