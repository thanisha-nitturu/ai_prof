...
/**
 * Options helper for Tiny Video Lesson plugin.
 *
 * @module    tiny_videolesson/options
...
/**
 * Register the options for the Tiny Video Lesson plugin.
 *
...
/**
 * Get the permissions configuration for the Tiny Video Lesson plugin.
 *
 * @param {TinyMCE} editor
 * @returns {object}
 */
...
/**
 * Check whether any Video Lesson Permission is available.
 *
 * @param {TinyMCE} editor
 * @returns {boolean}
 */
export const hasAnyVideoLessonPermission = (editor) => {
