...
$string['emailfooterdefaultnamedesc'] = 'If checked, then default reminder email footer will contain a link to the ai.prof calendar. Otherwise, the content provided in customized footer will be used.';
...
$string['moodlecalendarname'] = 'ai.prof Calendar';
