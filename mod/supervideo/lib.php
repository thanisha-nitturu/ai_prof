...
/**
 * Sets the special supervideo display on course page.
 *
 * @param cm_info $cm Course-module object
 */
function supervideo_cm_info_view(cm_info $cm) {
    global $DB, $PAGE, $CFG;
    ...
    require_once("{$CFG->dirroot}/mod/supervideo/classes/output/view.php");

    $view = new \mod_supervideo\output\view($cm, $course, $supervideo, $context);
    
    // Disable freemode for inline rendering
    $view->freemode = false;
    ...
    $html .= $view->errosmessages;

    $aspectstyle = '';
    if (isset($supervideo->playersize) && $supervideo->origem != 'upload') {
    ...
    $html .= "<div class=\"supervideo-inline-container\" id=\"supervideo_area_embed\"{$directionattr} style=\"{$aspectstyle}\">";
    $html .= $videoplayer;
    $html .= "</div>";
