...
function useredit_shared_definition(&$mform, $editoroptions, $filemanageroptions, $user) {
    ...
    if (empty($USER->newadminuser)) {
        ...
        // Custom notice for assessment identification
        $mform->addElement('static', 'assessment_notice', '', '<div class="alert alert-info" style="margin-bottom: 20px;">' .
            '<strong>Required for Identification:</strong> Please upload a clear, front-facing profile picture. This is used for verification during your assessments.' .
            '</div>');
